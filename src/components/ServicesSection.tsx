  ...
  const services = [
    {
      ...
      description:
        "Tailored training programs designed specifically for your goals, fitness level, and schedule.",
      features: [
    ...
    },
    {
      ...
      description:
        "Simple, sustainable meal strategies that fit your lifestyle and preferences.",
      features: [
    ...
    },
    {
      ...
      description:
        "Regular progress tracking and plan adjustments to keep you on track.",
      features: [
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need to transform your body in 90 days, backed by
              science and proven with hundreds of successful transformations.
            </p>
          </div>
